...
def random_forest(year, quarter):
    ...
    real_time_plot = plot_forecast_real_time(latest_y_train.iloc[1:], real_time_y_pred, CI, "RF Model")
    latest_plot = plot_forecast_vintage(latest_y_train.iloc[1:], latest_y_pred, CI, "RF Model")
