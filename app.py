        ...
        html.Div([
            ...
            dbc.Row([
                dbc.Col(html.Div([
                    ...
                    html.P(f"We have trained the AR Model using your selection of training data of {year} Q{quarter}. Using a fixed window approach to train and backtest our model, our 8 step forecast has indicated that the RMSFE is {ar_results['rmsfe']}."),
                ]), width=4),
                dbc.Col(html.Div([
                    html.P([adlmodel]),
                    ...
                    html.P(f"We have trained the ADL Model using your selection of training data of {year} Q{quarter}. Using a fixed window approach to train and backtest our model, our 8 step forecast has indicated that the RMSFE is {adl_results['rmsfe']}."),
                ]), width=4),
                dbc.Col(html.Div([
                    html.P([rfmodel]),
                    ...
                    html.P(f"We have trained the RF Model using your selection of training data of {year} Q{quarter}. Using a fixed window approach to train and backtest our model, our 8 step forecast has indicated that the RMSFE is {rf_results['rmsfe']}."),
                    ]), width=4),
                ]),
            ], className= 'evaluation-container'),
