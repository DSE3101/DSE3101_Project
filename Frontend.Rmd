...
# Dropdown 
Users are able to select the shock they wish to implement 
```{r}
...
server <- function(input, output) {
  output$timeSeriesGraph <- renderPlot({
    ...
    plot <- ggplot() +
      ...
      geom_line(data = highlightedData, aes(x = date, y = value), color = "red", size = 1.5) + #Colour the training data red
